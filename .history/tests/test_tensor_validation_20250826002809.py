...
class TestTensorMaterialValidation:
    ...
    def test_si_unit_helpers(self):
        ...
        assert nm(500) == 500e-9  # 500nm to meters
        assert um(1.5) == 1.5e-6  # 1.5um to meters
        assert mm(2.0) == 2.0e-3  # 2mm to meters
    ...
    def test_wavelength_range_validation(self):
        ...
        assert mat.wavelength_range == (400e-9, 700e-9)
    ...
    def test_thickness_range_validation(self):
        ...
        assert mat.thickness_range == (10e-9, 10e-6)
    ...
    def test_dispersive_source_warning(self):
        ...
        with pytest.warns(None) as warning_list:
            mat = TensorMaterial(epsilon_tensor=eps_func, source="dummy_source")
        
        # Check no warnings were raised
        dispersive_warnings = [w for w in warning_list if "source" in str(w.message)]
        assert len(dispersive_warnings) == 0
    ...
    def test_backward_compatibility(self):
        ...
        assert_allclose(mat.epsilon_tensor(500e-9), eps)
        ...
        mat = TensorMaterial(epsilon_tensor=eps_func)
        assert_allclose(mat.epsilon_tensor(500e-9), np.eye(3) * 2.25)
    ...
    def test_validation_with_complex_tensors(self):
        ...
        assert_allclose(mat.epsilon_tensor(500e-9), eps_complex)
        ...
        assert_allclose(mat.epsilon_tensor(500e-9), expected)
