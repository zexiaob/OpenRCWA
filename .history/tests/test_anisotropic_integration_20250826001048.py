...
class TestAnisotropicFresnel:
    ...
    @pytest.mark.skip(reason="Solver integration with tensor materials not yet complete")
    def test_energy_conservation_lossless(self):
        ...
        try:
            ...
            R_total = result['RTot'] if isinstance(result, dict) else result.RTot
            T_total = result['TTot'] if isinstance(result, dict) else result.TTot
            ...
            # If solver doesn't support anisotropic materials yet, skip this test
