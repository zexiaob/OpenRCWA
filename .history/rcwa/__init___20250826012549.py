...
from rcwa.model.layer import LayerStack, Layer, HalfSpace, freeSpaceLayer
from rcwa.model.transforms import rotate_layer

# Syntax sugar for common half-spaces
def Air():
    """Convenience function for air half-space"""
    return HalfSpace(Material("Air", n=1.0))

def Substrate(material):
    """Convenience function for substrate half-space"""
    return HalfSpace(material)
