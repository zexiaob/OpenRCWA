...
class PatternedLayer(Layer):
    ...
    def convolution_matrix(self, harmonics_x: np.ndarray, harmonics_y: np.ndarray,
        ...
        :param tensor_component: Tensor component ('xx', 'xy', 'yy', 'yx', 'zz')
        :return: Convolution matrix
        """
        # Generate cache key
        ...
        if tensor_component not in convolution_matrices:
            raise ValueError(f"Unknown tensor component: {tensor_component}")
        
        result = convolution_matrices[tensor_component]
