...
class Shape(ABC):
    ...
    self._param_dependencies = set(params.keys()) if params else set()
    # Subclasses may declare parametric fields; default none
    self._parametric_fields: Tuple[str, ...] = tuple()
...
class Rectangle(Shape):
    ...
    self.center = Point(*center) if not callable(center) else center
    self.width = width
    self.height = height 
    self.rotation = rotation
    self._parametric_fields = ('center', 'width', 'height', 'rotation')
...
class Circle(Shape):
    ...
    self.center = Point(*center) if not callable(center) else center
    self.radius = radius
    self._parametric_fields = ('center', 'radius')
...
class Ellipse(Shape):
    ...
    self.rotation = rotation
    self._parametric_fields = ('center', 'a', 'b', 'rotation')
