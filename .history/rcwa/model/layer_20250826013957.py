...
class LayerStack:
    ...
    def __init__(self, *internal_layers: Layer,
                 ...
                 superstrate: Union[Layer, 'HalfSpace'] = None,
                 substrate: Union[Layer, 'HalfSpace'] = None,
        ...
        elif hasattr(superstrate_layer, 'to_layer'):
            # It's a HalfSpace
            self.incident_layer = superstrate_layer.to_layer()
        else:
            # It's a Layer
            self.incident_layer = superstrate_layer
        ...
        elif hasattr(substrate_layer, 'to_layer'):
            # It's a HalfSpace
            self.transmission_layer = substrate_layer.to_layer()
        else:
            # It's a Layer
            self.transmission_layer = substrate_layer
...
# Predefined HalfSpace constants for common materials
Air = HalfSpace(Material(er=1.0, ur=1.0, n=1.0))
